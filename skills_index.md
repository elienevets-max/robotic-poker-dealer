# Robotic Poker Dealer — Skills Index

A searchable catalog of skills and knowledge modules relevant to the Robotic Poker Dealer project and its creator's broader expertise.
...
Frameworks for understanding cognitive biases, making better decisions under uncertainty, and applying behavioral science to poker, business, and investing.

#### 1. Thinking, Fast and Slow
- **File:** [`skills/thinking-fast-and-slow.md`](skills/thinking-fast-and-slow.md)
...
The science and practice of accurate prediction — base rate reasoning, Bayesian updating, calibration, and structured forecasting methods.

#### 2. Superforecasting
- **File:** [`skills/superforecasting.md`](skills/superforecasting.md)
...
| 10-Point Decision Quality Checklist | Thinking, Fast and Slow | Pre-decision bias scan for major decisions |
